...
WorldCoordinateComponent::WorldCoordinateComponent() : coord_(0, 0, 0) {
	worldMatrix_ = XMMatrixTranslation(static_cast<float>(coord_.x * static_cast<int>(DIMENSION)),
										static_cast<float>(coord_.y * static_cast<int>(DIMENSION)),
										static_cast<float>(coord_.z * static_cast<int>(DIMENSION)));
}
